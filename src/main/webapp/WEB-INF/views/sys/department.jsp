...
<div class="panel panel-inverse">
    ...
    <div class="panel-body">
        ...
        <table id="department_table" class="table table-bordered table-striped table-hover display" cellspacing="0" width="100%">
        </table>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form method="POST" action="/" class="form-horizontal" id="departmentform">
